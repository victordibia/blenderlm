      ...
      <div className="flex h-16 items-center gap-x-4 px-4">
        ...
        <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          ...
          <div className="flex items-center gap-x-4 lg:gap-x-6 ml-auto">
            {/* Search */}
            <form className="relative hidden h-8">
              <label htmlFor="search-field" className="sr-only">
                Search
              </label>
              <Search className="pointer-events-none absolute inset-y-0 left-2 h-full w-5 text-secondary" />
              <input
                id="search-field"
                type="search"
                placeholder="Search..."
            ...
            {/* User Menu - Custom implementation with Tailwind */}
            {user && (
              <div className="relative" ref={userMenuRef}>
                ...
                {userMenuOpen && (
                  <div className="absolute right-0 mt-2 w-48 origin-top-right rounded-md bg-primary py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <a
                      href="#"
                      onClick={(e) => {
                        e.preventDefault();
